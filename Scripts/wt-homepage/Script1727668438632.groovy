...
Mobile.tap(findTestObject('Object Repository/Edit Profile/com.horcrux.svg.SvgView'), 0)

Mobile.tap(findTestObject('Object Repository/Edit Profile/android.widget.TextView - SIGN IN AS GUEST'), 0)
